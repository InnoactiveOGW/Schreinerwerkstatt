...
//public class MeshinatorBackup : MonoBehaviour
//{
...
//                        Rigidbody rbNew = newGO.GetComponent<Rigidbody>();
//                        if (rb != null && rbNew != null)
//                        {
...
//                            rb.mass = totalMass * (hullVolume / totalVolume);
//                            rbNew.mass = totalMass * (subHullVolume / totalVolume);

//                            // Set the old velocity onto the new GameObject's rigidbody
//                            rbNew.velocity = rb.velocity;

//                            // Set the centers of mass to be within the new meshes
//                            rb.centerOfMass = newMesh.bounds.center;
//                            rbNew.centerOfMass = subHullMesh.bounds.center;
//                        }
//                    }
//                }
